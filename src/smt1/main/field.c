...
INCLUDE_ASM("asm/smt1/main/nonmatchings/field", FieldMapKill);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", func_800158A0);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", FieldMapClose1);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", FieldMapSleepEvent);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", FieldMapSleep);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", UpdateField);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", FieldMovement);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", func_80016504);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", ExecuteFieldMovement);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", func_80016A10);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", SsGetMute);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", func_80016B10);
...
INCLUDE_ASM("asm/smt1/main/nonmatchings/field", AddFieldOverlays);

INCLUDE_ASM("asm/smt1/main/nonmatchings/field", EncounterBarProc);
...
INCLUDE_ASM("asm/smt1/main/nonmatchings/field", func_80017B4C);
