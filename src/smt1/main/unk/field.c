...
void CreateFieldMap(struct return_thing * arg0) {
    ...
    if (FieldMapExists == 0) {
        FieldMapExists = 1;
        obj = CreateObject(
            NULL, FieldMapKill, FirstObjectPtrPtr->first, 
...
void func_800152D0(struct object* arg0) {
    ...
    case 2:
        func_80044FA0(
            ...
            &D_800B74F0.dat0[D_800B74F0.dat0[3] / 4], 
            D_800B74F0.dat2, D_800B74F0.dat3
        );
        if (func_8004ED78() == 0) {
        ...
        if (func_8004ED78() != 0) {
            ...
            D_800B74F0.dat1 = 0;
            if (func_8004C06C(FLAG_NEBIROS) == 0) {
...
void FieldMapProc(struct object * self) {
...
void FieldMapKill(struct object * self) {
    FntPrint("\n\n\n\n\n\n  __FieldMapKill");
    if (FieldMapExists != 0) {
...
void func_800158A0(struct object * self) {
...
void FieldMapSleepEvent(struct object * self) {
    ...
    case 2:
        ...
        break;
    case 3:
        if (func_8004C06C(FLAG_ABOUT_TO_HEAR_HEROINE)) {
...
void FieldMovement(void) {
    ...
    if (temp_v0_2 > -1) {
        ...
        if (temp_s0 == 9) {
            ...
            return;
        } else if ((temp_s0 != 8) && (!func_8004C06C(0xFA)) && ((func_8004C06C(0xA2) == 1) || (func_8004C06C(FLAG_OCTOPUS) == 1)) && (temp_s0 == 0xA)) {
...
void EncounterBarProc(void) {
    ...
    func_8004C06C(FLAG_NO_ENCOUNTERS)) {
        var_s0 = 0;
    } else {
        var_s0 = 1;
        if (((temp_v0 - 1)) >= 0x23) {
