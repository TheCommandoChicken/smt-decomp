...
struct object * GameInit(void) {
	...
	GameDataInit();
	PersistentObjects.intro_manager = CreateObject(IntroManagerProc, EmptyProc, FirstObjectPtrPtr->first, 1, 0, sizeof(struct intro_manager));
...
void func_800145CC(s32 (* arg0)(void)) {
	...
	func_80018F6C(0, 0);
	obj = CreateObject(func_80014698, NULL, FirstObjectPtrPtr->first, -3, 0, sizeof(struct unk_data_0));
	if (obj == NULL) return;
	data = obj->data;
	data->counter = 0;
	data->unk0 = arg0;
...
struct object * func_80014A2C(void) {
	...
	temp_v0 = CreateObject(func_80014AF4, NULL, FirstObjectPtrPtr->first, 0xC00000, 0, sizeof(struct unk_data_1));
